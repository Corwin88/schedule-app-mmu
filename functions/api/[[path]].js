// Cloudflare Pages Function — обрабатывает все запросы /api/*
// Файл [[path]].js = catch-all роут (аналог req.url в Netlify)
...
// ── Главный обработчик ──
// В Pages Functions env-переменные приходят через context.env, а не process.env
